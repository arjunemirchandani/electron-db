...
export function NotesIcon({ size = 15 }: IconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
...
export function TagIcon({ size = 15 }: IconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
...
export function PanelLeftIcon({ size = 15 }: IconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
