...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === 'success') {
    // house: success wears palette A's green (see also root border below)
    icon = <CircleCheckIcon className="text-[hsl(145_60%_55%)]" aria-hidden="true" />
  }
